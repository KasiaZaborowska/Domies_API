...
namespace DomiesAPI.Controllers
{
    ...
    public class UserAccountController : ControllerBase
    {
            ...
            if (ModelState.IsValid)
            {
                ...
                else
                {
                    ...
                    <body>
                      <div class='container'>
                        <div class='header'>
                          <h1>Witamy w [Nazwa Twojej Aplikacji]!</h1>
                        </div>
                        <div class='content'>
                          <p>Witaj,</p>
                          <p>Dziękujemy za utworzenie konta w <strong>[Nazwa Twojej Aplikacji]</strong>. Aby zakończyć proces rejestracji, kliknij poniższy przycisk, aby zweryfikować swój adres e-mail:</p>
                          <a href='{{verificationLink}}' class='button'>Zweryfikuj swój e-mail</a>
                          <p>Jeśli nie zakładałeś/aś konta w naszej aplikacji, zignoruj tę wiadomość.</p>
                        </div>
                        <div>
                          <br>
                          <div class='advice'>
        ...
        //[HttpPost("verify")]
        //public async Task<IActionResult> VerifyUserEmail([FromBody] string token)
        //{
